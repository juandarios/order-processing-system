...
public interface IPaymentGatewayClient
{
    ...
    /// </summary>
    /// <param name="paymentId">The unique identifier of the payment record.</param>
    ...
    /// <exception cref="Domain.Exceptions.PaymentGatewayUnavailableException">
    /// Thrown when the gateway is unavailable after all resilience retries are exhausted.
    /// </exception>
    Task<bool> ChargeAsync(Guid paymentId, Guid orderId, decimal amount, string currency, CancellationToken ct = default);
}
